...
## CAMELYON16/17
The [CAMELYON16](https://camelyon16.grand-challenge.org/) and [CAMELYON17](https://camelyon17.grand-challenge.org/) are released under CC0 (public domain). They can be downloaded via [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html):
...
CPTAC-CCRCC is a 190 GB dataset boasting 783 clear cell renal carcinoma WSIs.
...
TCGA-BRCA is a dataset of invasive breast cancer.
