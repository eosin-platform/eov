...
[![Status: Actively Maintained](https://img.shields.io/badge/
status-actively%20maintained-2ea44f)](https://github.com/eosin-platform/eov/pulse)
...
```bash
# Make it executable
chmod +x eov-v0.1.20-linux-x86_64.AppImage

# Run it directly
./eov-v0.1.20-linux-x86_64.AppImage

# Install it system-wide (optional)
sudo mv eov-v0.1.20-linux-x86_64.AppImage /usr/local/bin/eov
